...
const About: React.FC = () => {
  ...
  useEffect(() => {
    ...
    <img className='background1' src="/background1.svg" alt="" />
    <img className='background2' src="/background2.svg" alt="" />
    <img className='background3' src="/background3.svg" alt="" />

    <img className='background1Mobile' src="/background1Mobile.svg" alt="" />
    <img className='background2Mobile' src="/background2Mobile.svg" alt="" />
    <img className='background3Mobile' src="/background3Mobile.svg" alt="" />
